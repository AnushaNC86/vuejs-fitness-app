  ...
  <section id="grid">
    ...
    >
      <div>
        ...
        <!-- 
            Display a workout type icon based on the index of the workout day.
            The workout follows a rotating Push-Pull-Legs (PPL) pattern:
                - Push (dumbbell icon) when workoutIdx % 3 == 0
                - Pull (weight-hanging icon) when workoutIdx % 3 == 1
                - Legs (bolt icon) when workoutIdx % 3 == 2
            This ensures the correct icon is shown for each workout type based on the day's index.
        -->
